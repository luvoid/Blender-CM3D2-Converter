...
##### RNA #####   # CM3D2 Converter: added class_list param
def dump_rna_messages(msgs, reports, settings, verbose=False, class_list=bpy.types.ID.__base__.__subclasses__()): 
    """
